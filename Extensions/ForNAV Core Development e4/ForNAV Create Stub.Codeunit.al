Codeunit 6188773 "ForNAV Create Stub"
{
    ...
    procedure FromCheck(Args: Record "ForNAV Check Arguments";
    var Check: Record "ForNAV Check";
    var Stub: Record "ForNAV Stub";
    GenJnlLine: Record "Gen. Journal Line")var CustLedgerEntry: Record "Cust. Ledger Entry";
    ...
    local procedure InitCode(Args: Record "ForNAV Check Arguments";
    Check: Record "ForNAV Check";
    GenJnlLine: Record "Gen. Journal Line";
    var CustLedgEntry: Record "Cust. Ledger Entry";
    var VendLedgEntry: Record "Vendor Ledger Entry";
    var FoundLast: Boolean;
    var FoundNegative: Boolean)begin
        if not Args."Test Print" then begin
            FoundLast:=true;
            case Check."Application Method" of Check."application method"::OneLineOneEntry: FoundLast:=false;
            Check."application method"::OneLineID: case Check."Balancing Type" of Check."balancing type"::Customer: begin
                    CustLedgEntry.Reset;
                ...
                Check."balancing type"::Vendor: begin
                    VendLedgEntry.Reset;
            ...
            Check."application method"::MoreLinesOneEntry: FoundLast:=false;
            end;
        end;
    end;
    local procedure RepeatCode(Args: Record "ForNAV Check Arguments";
    Check: Record "ForNAV Check";
    var Stub: Record "ForNAV Stub";
    GenJnlLine: Record "Gen. Journal Line";
    var CustLedgEntry: Record "Cust. Ledger Entry";
    ...
    FoundNegative: Boolean)var LineAmount2: Decimal;
    CurrentLineAmount: Decimal;
    GenJnlLine2: Record "Gen. Journal Line";
    Text016: label 'In the Check report, One Check per Vendor and Document No.\', Comment='DO NOT TRANSLATE';
    Text017: label 'must not be activated when Applies-to ID is specified in the journal lines.', Comment='DO NOT TRANSLATE';
    begin
        if Check."Application Method" = Check."application method"::MoreLinesOneEntry then GetGenJnlLnForMoreLinesOneEntry(GenJnlLine, GenJnlLine2);
        repeat if not Args."Test Print" then begin
                if FoundLast then begin
                    if RemainingAmount <> 0 then begin
                        ...
                        Stub."Posting Date":=GenJnlLine."Posting Date";
                        Stub.Insert;
                        RemainingAmount:=0;
                    end
                    else
                ...
                begin
                    case Check."Application Method" of Check."application method"::OneLineOneEntry: begin
                        case Check."Balancing Type" of Check."balancing type"::Customer: begin
                            CustLedgEntry.Reset;
                        ...
                        Check."balancing type"::Vendor: begin
                            ...
                            Stub."Currency Code":=GenJnlLine."Currency Code";
                            Stub."Posting Date":=GenJnlLine."Posting Date";
                            Stub.VendUpdateAmounts(VendLedgEntry, RemainingAmount, LineAmount2, Check."Application Method");
                        end;
                        end;
                    ...
                    Check."application method"::OneLineID: begin
                        case Check."Balancing Type" of Check."balancing type"::Customer: begin
                            Stub."Currency Code":=GenJnlLine."Currency Code";
                            Stub."Posting Date":=GenJnlLine."Posting Date";
                            Stub.CustUpdateAmounts(CustLedgEntry, RemainingAmount, LineAmount2);
                        ...
                        RemainingAmount:=RemainingAmount - LineAmount2;
                        CurrentLineAmount:=LineAmount2 end;
                    Check."application method"::MoreLinesOneEntry: begin
                        ...
                        begin
                            case Check."Balancing Type" of Check."balancing type"::"G/L Account": begin
                            ...
                            Check."balancing type"::Customer: begin
                                CustLedgEntry.Reset;
                                CustLedgEntry.SetCurrentkey("Document No.");
                            ...
                            Check."balancing type"::Vendor: begin
                                ...
                                Stub."Currency Code":=GenJnlLine."Currency Code";
                                Stub."Posting Date":=GenJnlLine."Posting Date";
                                Stub.VendUpdateAmounts(VendLedgEntry, CurrentLineAmount, LineAmount2, Check."Application Method");
                                Stub.Amount:=CurrentLineAmount; // WTF??
                            end;
                            Check."balancing type"::"Bank Account": begin
                                Stub."Document No.":=GenJnlLine2."Document No.";
                                Stub."External Document No.":=GenJnlLine2."External Document No.";
                                Stub.Amount:=CurrentLineAmount;
                                Stub."Discount Amount":=0;
    ...
    local procedure GetGenJnlLnForMoreLinesOneEntry(GenJnlLine: Record "Gen. Journal Line";
    var GenJnlLine2: Record "Gen. Journal Line")begin
        GenJnlLine2.Reset;
