Report 6188685 "ForNAV Item - Label"
{
    Caption = 'Item Label';
    UsageCategory = ReportsAndAnalysis;
    WordLayout = './Layouts/ForNAV Item - Label.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(List;Item)
        {
            ...
            RequestFilterFields = "No.", Description, "Statistics Group", Inventory, "Manufacturing Policy";
