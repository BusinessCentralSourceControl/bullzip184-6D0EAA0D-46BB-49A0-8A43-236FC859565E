codeunit 6189198 "ForNAV Application Insights"
{
    var AppInsightKey: Text;
    URL: label 'https://dc.services.visualstudio.com/v2/track', Locked=true;
    procedure Init(apiKey: Text)begin
        AppInsightKey:=apiKey;
    end;
    //
    // Track Event
    //
    procedure TrackEvent(eventName: Text;
    properties: Dictionary of[Text, Text];
    metrics: Dictionary of[Text, Decimal]): Text var JSONEventData: JsonObject;
    Result: Text;
    begin
    ...
    // Track Trace 
    //
    procedure TrackTrace(message: Text;
    properties: Dictionary of[Text, Text]): Text var JSONEventData: JsonObject;
    ...
    // Track page view
    //
    procedure TrackPageView(pageName: Text): Text var JSONEventData: JsonObject;
    ...
    // Track exception
    //
    procedure TrackException(message: Text;
    properties: Dictionary of[Text, Text];
    metrics: Dictionary of[Text, Decimal]): Text var JSONEventData: JsonObject;
    ...
    // Track core
    //
    local procedure Track(baseEventType: Text;
    JSONEventData: JsonObject;
    properties: Dictionary of[Text, Text];
    metrics: Dictionary of[Text, Decimal]): Text var Client: HttpClient;
    ...
    begin
        ...
        if(properties.Count() > 0)then begin
            foreach ValueName in properties.Keys()do begin
                ...
                JSONProperties.Add(ValueName, PropValue)end;
        ...
        if(metrics.Count() > 0)then begin
            foreach ValueName in metrics.Keys()do begin
                ...
                JSONMeasurements.Add(ValueName, MetricValue)end;
