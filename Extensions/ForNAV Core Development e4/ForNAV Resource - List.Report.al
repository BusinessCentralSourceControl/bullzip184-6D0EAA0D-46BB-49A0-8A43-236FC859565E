Report 6188676 "ForNAV Resource - List"
{
    Caption = 'Resource List';
    UsageCategory = ReportsAndAnalysis;
    WordLayout = './Layouts/ForNAV Resource - List.docx';
    DefaultLayout = Word;

    dataset
    {
        dataitem(List;Resource)
        {
            RequestFilterFields = "No.", Name, "Country/Region Code", "Date Filter", "Resource Group No.";
