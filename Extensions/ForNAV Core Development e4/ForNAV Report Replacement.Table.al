Table 6188487 "ForNAV Report Replacement"
{
    ...
    fields
    {
        ...
        field(6;"Replace-With Report Name";Text[249])
        {
            CalcFormula = lookup(AllObjWithCaption."Object Caption" where("Object Type"=const(Report), "Object ID"=field("Replace-With Report ID")));
            Caption = 'Report Name';
            Editable = false;
            FieldClass = FlowField;
        }
    ...
    procedure TestReport()begin
        Report.Run("Report ID");
    end;
    procedure CreateForNAVDefaultReportReplacement()begin
        ...
        //ReplaceReport( ,6188678); //ForNAV Reconcile A/P to G/L
        //ReplaceReport( ,6188681); //ForNAV Customer Payments
        //ReplaceReport( ,6188682); //ForNAV Vendor Payments
        ...
        //ReplaceReport( ,6188711); //ForNAV Inv. to G/L Reconcile
        ReplaceReport(1001, Report::"ForNAV Inventory Valuation");
        ReplaceReport(712, Report::"ForNAV Cust./Item Statistics");
    end;
    local procedure ReplaceReport(ID: Integer;
    WithID: Integer)begin
        "Report ID":=ID;
