Report 6188480 "ForNAV Service Shipment"
{
    Caption = 'Service Shipment';
    UsageCategory = ReportsAndAnalysis;
    WordLayout = './Layouts/ForNAV Service Shipment.docx';
    DefaultLayout = Word;

    dataset
    {
        dataitem(Header;"Service Shipment Header")
        {
            ...
            dataitem(ItemLine;"Service Shipment Item Line")
            {
                ...
                {
                    DataItemLink = "No."=FIELD("No."), "Table Line No."=FIELD("Line No.");
            ...
            dataitem(Line;"Service Shipment Line")
            {
