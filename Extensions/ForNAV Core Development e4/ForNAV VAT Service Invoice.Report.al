Report 6188477 "ForNAV VAT Service Invoice"
{
    Caption = 'Service Invoice';
    UsageCategory = ReportsAndAnalysis;
    WordLayout = './Layouts/ForNAV VAT Service Invoice.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header;"Service Invoice Header")
        {
            ...
            dataitem(ItemLine;"Service Invoice Line")
            {
                DataItemLink = "Document No."=field("No.");
                DataItemTableView = sorting("Service Item No.", "Service Item Line No.");
