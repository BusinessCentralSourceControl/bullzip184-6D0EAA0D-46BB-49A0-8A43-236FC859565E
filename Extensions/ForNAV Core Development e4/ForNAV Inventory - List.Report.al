Report 6188679 "ForNAV Inventory - List"
{
    Caption = 'Inventory List';
    UsageCategory = ReportsAndAnalysis;
    WordLayout = './Layouts/ForNAV Inventory - List.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(List;Item)
        {
            RequestFilterFields = "No.", Description, "Inventory Posting Group", "Date Filter", "Vendor No.";
