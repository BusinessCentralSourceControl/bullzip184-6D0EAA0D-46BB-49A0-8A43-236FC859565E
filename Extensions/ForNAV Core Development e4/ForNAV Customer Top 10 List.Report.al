Report 6188672 "ForNAV Customer Top 10 List"
{
    Caption = 'Customer Top 10 List';
    UsageCategory = ReportsAndAnalysis;
    WordLayout = './Layouts/ForNAV Customer Top 10 List.docx';
    DefaultLayout = Word;
...
#pragma warning restore AL0254 RequestFilterFields = "No.", Name, "Customer Posting Group", "Country/Region Code", "Date Filter";
