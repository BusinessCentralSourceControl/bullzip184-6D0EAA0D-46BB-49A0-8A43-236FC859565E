Report 6188689 "ForNAV Employee - Label"
{
    Caption = 'Employee Label';
    UsageCategory = ReportsAndAnalysis;
    WordLayout = './Layouts/ForNAV Employee - Label.docx';
    DefaultLayout = Word;

    dataset
    {
        dataitem(List;Employee)
        {
            RequestFilterFields = "No.", "First Name", "Last Name", "Country/Region Code";
