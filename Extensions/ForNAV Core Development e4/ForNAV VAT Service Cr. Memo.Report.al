Report 6188478 "ForNAV VAT Service Cr. Memo"
{
    Caption = 'Service Credit Memo';
    UsageCategory = ReportsAndAnalysis;
    WordLayout = './Layouts/ForNAV VAT Service Cr. Memo.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header;"Service Cr.Memo Header")
        {
            ...
            dataitem(ItemLine;"Service Cr.Memo Line")
            {
                DataItemLink = "Document No."=field("No.");
                DataItemTableView = sorting("Service Item No.");
            ...
            dataitem(Line;"Service Cr.Memo Line")
            {
                DataItemLink = "Document No."=FIELD("No.");
