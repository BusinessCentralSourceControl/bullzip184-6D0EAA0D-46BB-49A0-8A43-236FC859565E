Codeunit 6188772 "ForNAV Check Update Journal"
{
    ...
    var GenJnlLine: Record "Gen. Journal Line")var GenJnlLine2: Record "Gen. Journal Line";
    Text013: label '%1 already exists.', Comment='DO NOT TRANSLATE';
    GenJnlLine3: Record "Gen. Journal Line";
    BankAcc: Record "Bank Account";
    HighestLineNo: Integer;
    BalancingType: Option "G/L Account", Customer, Vendor, "Bank Account";
    Text014: label 'Check for %1 %2', Comment='DO NOT TRANSLATE';
    Text062: label 'G/L Account,Customer,Vendor,Bank Account', Comment='DO NOT TRANSLATE';
    begin
        if Args."Test Print" then exit;
        BankAcc.Get(Check."Bank Account No.");
        BankAcc."Last Check No.":=Check."Check No.";
        BankAcc.Modify;
        if Args."Test Print" then exit;
        if Check."Check No." <> GenJnlLine."Document No." then begin
            GenJnlLine3.Reset;
            ...
            GenJnlLine3.SetRange("Document No.", Check."Check No.");
            if GenJnlLine3.Find('-')then GenJnlLine3.FieldError("Document No.", StrSubstNo(Text013, Check."Check No."));
        end;
        if Check."Application Method" <> Check."application method"::MoreLinesOneEntry then begin
            GenJnlLine3:=GenJnlLine;
            GenJnlLine3.TestField("Posting No. Series", '');
            GenJnlLine3."Document No.":=Check."Check No.";
        ...
        begin
            ...
            if GenJnlLine2.Find('-')then begin
                ...
                repeat if GenJnlLine2."Line No." > HighestLineNo then HighestLineNo:=GenJnlLine2."Line No.";
            ...
            if BalancingType <> Balancingtype::"G/L Account" then GenJnlLine3.Description:=StrSubstNo(Text014, SelectStr(BalancingType + 1, Text062), Check."Balancing No.");
            GenJnlLine3.Validate(Amount, -Check.Amount);
